...
{
    nvgr = dlopen("gralloc.zynqmp.so", RTLD_LOCAL | RTLD_LAZY);
        ...
        int *out_fence) const
{
    ...
    *out_fence = -1;
    //hack
    return 0;//nvgr_decompress(handle, in_fence, out_fence);
}

void open_fb(framebuffer_device_t** fb_dev)
{
